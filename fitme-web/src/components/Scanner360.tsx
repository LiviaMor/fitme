        ...
        {!result && !processing && (
          <>
            ...
            <div className="max-w-sm mx-auto">
              {/* Video container - aspect ratio 9:16 (celular) */}
              <div className="relative bg-black rounded-2xl overflow-hidden border-2 border-purple-300" style={{ aspectRatio: "9/16" }}>
                {/* Video sempre no DOM */}
                <video
                  ref={videoRef}
                  autoPlay
